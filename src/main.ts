 ...
 */
const terminalSessions = new WeakMap<Terminal, number>();
 ...
 */
function handleBell(terminal: Terminal): void {
  const settings = getSettings();
  ...
  if (panelId !== undefined && windowFocused && isPanelActive(panelId)) return;
